...
// FIX: प्रोडक्शन और लोकलहोस्ट दोनों के लिए मजबूत कुकी कॉन्फ़िगरेशन
const getCookieOptions = () => ({
  httpOnly: true,
  // अगर एनवायरनमेंट 'development' नहीं है (यानी Render प्रोडक्शन है), तो true रहेगा
  secure: process.env.NODE_ENV !== 'development',
  // क्रॉस-ओरिजिन रिक्वेस्ट्स (Render Backend -> Frontend) के लिए 'None' होना जरूरी है
...
export const logoutAdmin = async (req, res) => {
  try {
    // FIX: लॉगआउट करते समय भी सेम कुकी ऑप्शंस पास करना जरूरी है ताकि कुकी डिलीट हो सके
    res.clearCookie('token', {
      httpOnly: true,
      secure: process.env.NODE_ENV !== 'development',
      sameSite: process.env.NODE_ENV !== 'development' ? 'None' : 'Lax',
